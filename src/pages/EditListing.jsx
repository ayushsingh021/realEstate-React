...
export default function EditListing() {
  ...
  //validation for editing the listing data
  useEffect(() => {
  ...
  async function onSubmit(e) {
    ...
    //adding to database
    const docRef = doc(db, "listings", params.listingID);
    // const docRef = await addDoc(collection(db , "listings"), formDataCopy); //adds new document in collections

    await updateDoc(docRef, formDataCopy); //updates existing doc of reference in the collection
    setLoading(false);
        ...
        <div className="flex items-center mb-6">
          <div>
            ...
            <div className=" w-full flex items-center justify-center space-x-6">
              ...
              {type === "rent" && (
                <div>
                  <p className="w-full text-md whitespace-nowrap font-semibold">
                    {" "}
                    ₹ / Month
                  </p>
                </div>
